...
docker run -i -t --dns 127.0.0.1 -e NODE_TYPE=m -e DEVICE_TYPE=CPU -v /home/$( whoami )/hadoop_input:/mnt -P --name master -h master.mycorp.kom yiwei1012/hadoop-hsa-nn-dn:1.0
...
#docker run -d -t --dns 127.0.0.1 -e NODE_TYPE=s -e DEVICE_TYPE=CPU -e JOIN_IP=$FIRST_IP -P --name slave5 -h slave5.mycorp.kom yiwei1012/hadoop-hsa-dn:1.0
...
#docker run -i -t --dns 127.0.0.1 -e NODE_TYPE=m -e JOIN_IP=$FIRST_IP -e DEVICE_TYPE=CPU -v /home/$( whoami )/hadoop_input:/mnt -P --name master -h master.mycorp.kom yiwei1012/hadoop-hsa-nn-dn:1.0
